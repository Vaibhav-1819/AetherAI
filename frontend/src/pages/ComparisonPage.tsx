  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <div className="flex justify-between items-end mb-10">
        ...
        <div className="text-xs font-bold uppercase tracking-widest text-zinc-500 bg-zinc-900 px-4 py-2 rounded-full border border-zinc-800">
          ...
          {pinnedCities.map((city) => {
            ...
            return (
              <motion.div
                ...
                layout
              >
                <Card className="h-full bg-zinc-900 border-zinc-800 relative group overflow-hidden">
                    ...
                    <div className="space-y-3 pt-4 border-t border-zinc-800">
                       ...
                       <div className="flex gap-2">
                          <div className={`flex-1 p-3 rounded-xl border flex flex-col items-center gap-2 ${
                            data.signature_trend?.[0]?.traffic > 40 ? 'bg-blue-500/10 border-blue-500/30' : 'bg-zinc-800/20 border-zinc-800'
                          }`}>
                          ...
                          <div className={`flex-1 p-3 rounded-xl border flex flex-col items-center gap-2 ${
                            data.signature_trend?.[0]?.industrial > 40 ? 'bg-orange-500/10 border-orange-500/30' : 'bg-zinc-800/20 border-zinc-800'
                          }`}>
                          ...
                          <div className={`flex-1 p-3 rounded-xl border flex flex-col items-center gap-2 ${
                            data.signature_trend?.[0]?.construction > 40 ? 'bg-amber-500/10 border-amber-500/30' : 'bg-zinc-800/20 border-zinc-800'
                          }`}>
